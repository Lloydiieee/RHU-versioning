            ...
            <div class="card-aside-wrap">
                <div class="card-content">
                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/prenatal/health">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/prenatal/tetanus-toxoid">
                    ...
                    <div class="card-inner">
                        <div class="nk-block">
                            ...
                            @endif
                            <form action="{{ route('tetanus-toxoid.save') }}" method="POST" autocomplete="off">
                                @csrf
